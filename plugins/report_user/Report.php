...
class Report extends \ReportPlugin
{
    ...
    public function get_courses_filter()
    {
        ...
        if (isset($_POST['update_tempdata'])) {
            ...
            $temp = [
                ...
                'sub_filters' => (isset($_POST['courses_filter']) ? $_POST['courses_filter'] : []),
        ...
        $classrooms_editions_info)
    {
        ...
        $th1[] = ['colspan' => $colspan2, 'value' => $lang->def('_STATUS')];
        //$th1[] = '';
    ...
    public function _get_LO_query($type = 'html', $report_data = null, $other = '')
    {
        ...
        //retrievescorm score
        $query = ' t1.idOrg, t2.idUser, t1.idCourse, t2.score_raw, t2.score_min, t2.score_max, '
