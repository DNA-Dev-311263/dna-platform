...
class Form
{
     ...
     * @param bool   $inline   if true use <span> , else <div>
     *
    ...
    /**
     * public static function getLineDatefield( $css_line, $css_label, $label_name, $css_text, $id, $name, $value, $alt_name, $maxlenght, $other_param, $other_after, $other_before ).
     *
     * @param string $css_line     css for the line
     * @param string $css_label    css for the label
     * @param string $label_name   text contained into the label
     ...
     * @param bool   $is_checked  true if checkbox is checked
     ...
     * @param bool   $is_checked  optional,if true the checkbox is checked, default is false
     * @param string $other_param added in the html code
     *
     * @return string with the html code for the input type="checkbox" element
     */
     ...
     * @param string $name        the name of the element
     * @param string $value       default value for the input field
     * @param bool   $is_checked  true if radio is checked
     * @param string $other_param added in the html code
     *
     ...
     * @param string $name       the name of the element
     * @param string $value      value for the input field
     * @param bool   $is_checked optional,if true the radio is checked, default is false
     *
     * @return string with the html code for the input type="radio" element
     */
    ...
    /* //ABR
     * public static function getInputNumberfield( $css_text, $id, $name, $value, $alt_name, $min_value, $max_value, $other_param ).
     *
     * @param string $css_text    the css class for the input element
     * @param string $id          the id of the element
     * @param string $name        the name of the element
     * @param string $value       the default value for the input field
     * @param string $alt_name    the alt name for the field
     * @param $min_value 		  min number allowed
     * @param $max_value 		  max number allowed
     * @param string $other_param other element for the tag
     *
     * @return string with the html code for the input type="number" element
     */
    public static function getInputNumberfield($css_text, $id, $name, $value, $alt_name, $min_value = '', $max_value = '', $other_param = '')
    {
        $search = ['"', '<', '>'];
	...
	//ABR
    public static function getLineNumberfield($css_line, $css_label, $label_name, $css_text, $id, $name, $value, $alt_name, $min_value, $max_value, $other_param, $other_after, $other_before)
    {
        return '<div class="' . $css_line . '">'
        . $other_before
        . '<p><label class="' . $css_label . '" for="' . $id . '">' . $label_name . '</label></p>'
        . Form::getInputNumberfield($css_text, $id, $name, $value, $alt_name, $min_value, $max_value, $other_param)
        . $other_after
        . '</div>';
    }
    
    //ABR
    public static function getNumberfield($label_name, $id, $name, $min_value = '', $max_value = '', $value = '', $alt_name = '', $other_after = '', $other_before = '')
    {
        if ($alt_name == '') {
            $alt_name = strip_tags($label_name);
        }

        return Form::getLineNumberfield('form_line_l', 'floating', $label_name, 'textfield', $id, $name, $value, $alt_name, $min_value, $max_value, $other_param, $other_after, $other_before);
    }
