...
define( 'EMAIL_NOT_FOUND',          31 ); 		//ABR
define( 'FAILURE_GEN_FIRST_PWD',    32 );
define( 'FAILURE_SEND_FIRST_PWD',   33 );
define( 'USER_ALREADY_LOGIN',   	34 );
define( 'SUCCESS_SEND_FIRST_PWD',   35 );
