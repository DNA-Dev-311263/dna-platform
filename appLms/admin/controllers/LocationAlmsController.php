...
class LocationAlmsController extends AlmsController
{
    ...
    public function addmask()
    {
		...
		$location->location = '';
		$location->location_virtual = 0; //ABR gestione tipologia virtuale
    ...
    public function updatelocation()
    {
        ...
        $location_virtual = FormaLms\lib\Get::req('location_virtual', DOTY_INT, 0);	//ABR

        if ($location_new != '') {
            $answ = $this->model->updateLocation($location_id, $location_new, $location_virtual);
    ...
    public function insertlocation()
    {
        ...
        $re = $this->model->insertLocation($location, $location_virtual);		//ABR
