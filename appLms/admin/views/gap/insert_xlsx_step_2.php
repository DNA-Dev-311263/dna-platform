...
<?php
	...
	// Pulsanti
	echo
		 Form::openForm('insert_gap', 'index.php?r='.$base_link_gap.'/insertGapWizard&id_org='.$id_org, false, false, 'multipart/form-data')
	...
	$_params = array(
		'id'			=> 'checks_table',
		'ajaxUrl'		=> 'ajax.adm_server.php?r='.$base_link_gap.'/getInvalidList&id_org='.$id_org.'&op=ins&',
