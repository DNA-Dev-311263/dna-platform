...
<div class="std_block">
    ...
    $reset_url = 'ajax.adm_server.php?r=' . $this->link . '/multireset&amp;id_course=' . $id_course . '&amp;id_edition=' . $id_edition . '&amp;id_date=' . $id_date . ''; //ABR
    ...
    $exp_csv = 'index.php?r=' . $this->link . '/csvexport&amp;id_course=' . $id_course . '&amp;id_edition=' . $id_edition . '&amp;id_date=' . $id_date . '';
    ...
    $rel_action = '<a class="ico-wt-sprite subs_add" href="' . $add_url . '"><span>' . Lang::t('_ADD', 'subscribe') . '</span></a>'
        ...
        . '<a class="ico-wt-sprite subs_reset" href="'.$reset_url.'"><span>'  . Lang::t('_RESET_SELECTED', 'subscribe') . '</span></a>' 	//ABR
        ...
        . '<a class="ico-wt-sprite subs_export" href="' . $exp_csv . '"><span>Esporta Iscritti</span></a>'
