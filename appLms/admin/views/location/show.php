<?php FormaLms\lib\Get::title(Lang::t('_LOCATION', 'classroom')); ?>
<div class="std_block">

	<?php
$rel_action = [];
if ($this->perm['mod']) {
    $rel_action = ['<a id="addlocation_top" href="ajax.adm_server.php?r=alms/location/addmask" class="ico-wt-sprite subs_add" title="' . Lang::t('_ADD', 'standard') . '"><span>' . Lang::t('_ADD', 'standard') . '</span></a>',
...
$this->widget('table', [
    ...
    'columns' => [
        ['key' => 'location',
            ...
            'sortable' => true, ],
        ['key' => 'location_virtual',
            'label' => Lang::t('_VIRTUAL', 'location'),
            'sortable' => true, ],
        ['key' => 'location_classroom',
    ...
    'fields' => ['id_location', 'location', 'location_virtual', 'can_manage_classrooms', 'location_mod', 'location_del'],
    ...
    $this->widget('dialog', [
        ...
        'callEvents' => [
            ['caller' => 'addlocation_top', 'event' => 'click'],
            ['caller' => 'addlocation_bottom', 'event' => 'click'],
        ],
    ]);
