...
$_columns = [
    ...
    ['key' => 'internal_note', 'label' => Lang::t('_INTERNAL_NOTE', 'classroom')],						//ABR
    ['key' => 'students', 'label' => Lang::t('_STUDENTS', 'coursereport'), 'className' => 'img-cell'],
];

if ($permissions['add'] && $permissions['mod'] && $permissions['del']) {
    $_columns[] = ['key' => 'registro', 'label' => FormaLms\lib\Get::img('standard/date.png', Lang::t('_MOD', 'course')), 'className' => 'img-cell'];
}
...
if ($permissions['mod']) {
    $_columns[] = ['key' => 'mod', 'label' => FormaLms\lib\Get::img('standard/edit.png', Lang::t('_MOD', 'course')), 'className' => 'img-cell'];
}
...
$event = Events::trigger('core.course.edition.columns.listing', ['columns' => $_columns, 'fields' => ['id_date', 'code', 'name', 'status', 'date_begin', 'registro', 'date_end', 'classroom', 'internal_note', 'students', 'num_subscribe', 'subscription', 'presence', 'mod', 'del']]); //ABR
