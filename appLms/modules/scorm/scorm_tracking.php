...
class Scorm_Tracking
{
    ...
    public function getTrackData($idtrack = false)
    {
        if (!$idtrack) {
    ...
    public function saveHistory($idtrack, $score_raw, $score_max, $session_time, $lesson_status)
    {
        if ($lesson_status == '') {
            return true;
        } //no need to historize this values
        if ($score_raw == '') {
            $score_raw = 'NULL';
        }
        if ($score_max == '') {
        ...
        if ($score_raw != '') {
            $score_raw = str_replace(',', '.', $score_raw);
        }
    ...
    public function getParam($parampath, $SCOAccessibility = true)
    {
    ...
    public function setParam($parampath, $paramval, $SCOAccessibility = true, $create = true)
    {
