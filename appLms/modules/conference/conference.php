...
function conference_startnewconf($url)
{
    ...
    $GLOBALS['page']->add(
        ...
        . Form::getLineBox(
            ...
            Form::getInputDropdown('', 'room_type', 'room_type', $conf_system, $default, ''/*, 'onchange="getMaxRoom()"'*/)
        )
        ...
        . Form::getLineBox(
            $lang->def('_AT_HOUR'),
            Form::getInputDropdown('', 'start_time_hour', 'start_time[hour]', range(0, 23), importVar('start_time_hour', false, date('H')), '')
            . ' : '
            . Form::getInputDropdown('', 'start_time_minute', 'start_time[minute]', range(0, 59), importVar('start_time_hour', false, date('i')), '')
        )

        . Form::getLineBox(
            $lang->def('_MEETING_HOURS'),
            Form::getInputDropdown('', 'meetinghours', 'meetinghours', range(0, 5), importVar('meetinghours', false, 2), '')
        )
...
function conference_modconf($url = null)
{
    ...
    if (isset($_POST['update_conf'])) {
        ...
        $GLOBALS['page']->add(
                ...
                . Form::getLineBox(
                        $lang->def('_CONFERENCE_SYSTEM'),
                        Form::getInputDropdown('', 'room_type', 'room_type', $conf_system, $room_info['room_type'], ''/*, 'onchange="getMaxRoom()"'*/)
                )
                ...
                . Form::getLineBox(
                        $lang->def('_AT_HOUR'),
                        Form::getInputDropdown('', 'start_time_hour', 'start_time[hour]', range(0, 23), $hour, '')
                        . ' : '
                        . Form::getInputDropdown('', 'start_time_minute', 'start_time[minute]', range(0, 59), $min, '')
                )

                . Form::getLineBox(
                        $lang->def('_MEETING_HOURS'),
                        Form::getInputDropdown('', 'meetinghours', 'meetinghours', range(0, 5), $room_info['meetinghours'], '')
                )
