...
$plf = FormaLms\lib\Get::req('plf', DOTY_ALPHANUM, ($session->has('current_action_platform') && !empty($session->get('current_action_platform')) ? $session->get('current_action_platform') : FormaLms\lib\Get::cur_plat()));
