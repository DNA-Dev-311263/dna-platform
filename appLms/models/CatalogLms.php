...
class CatalogLms extends Model
{
     ...
     */
    protected function CategoryHasChildrenCourses($id_cat, $ileft, $iright, $showRulesValues = [self::SHOW_RULES_EVERYONE, self::SHOW_RULES_LOGGED_USERS, self::SHOW_RULES_SUBSCRIBED_USERS])
    {
        if ($this->show_all_category) {
            ...
            $query .= $this->getExtraCourseCondition();
    ...
    protected function getExtraCourseCondition(): string
    {
        return '';
    }


    public function getCourseAllInfo($id_course) {
		//ABR: restituisce le informazioni complete sul corso
		
		$res = array('course', 'course_cfield');
