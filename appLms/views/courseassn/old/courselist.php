...
function dateEndExists(array $the_course): bool
{
    return $the_course['date_end'] !== '0000-00-00';
}
    ...
    <div class="clearfix" id='mia_area_<?php echo $stato_corso; ?>'>
        ...
        <div class="col-xs-12 col-md-4">
            <div class="course-box"> <!-- NEW BLOCK -->
                    ...
                    <?php if (dateEndExists($course)) { // if exists end course, show it ?>
                    <div class="course-box__item course-box__item--half">
                        <div class="course-box__date-text">
                            ...
                            <?php echo dateEndExists($course).GetCourseDay($course)?>&nbsp;<?php echo GetCourseMonth($course)?>&nbsp;<?php echo GetCourseYear($course);?>
                        </div>
                    </div>
                    <?php } 
						...
						$divClass .= (dateEndExists($course) ? '--half' : '');
                    ?>
