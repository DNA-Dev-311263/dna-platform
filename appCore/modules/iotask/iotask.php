...
function ioTask_UIConnectorsList(&$module)
{
    ...
    $tb_connectors = new Table(FormaLms\lib\Get::sett('visuItem'), $lang->def('_CONNECTORS_TITLE'), $lang->def('_CONNECTORS_TITLE'));
...
function ioTask_UIConnectionsList(&$module)
{
    ...
    $tb_connections = new Table(FormaLms\lib\Get::sett('visuItem'), $lang->def('_CONN_TITLE'), $lang->def('_CONN_TITLE'));
...
function ioTask_UITaskList(&$module)
{
    ...
    $tb_tasks = new Table(FormaLms\lib\Get::sett('visuItem'), $lang->def('_TASKS'), $lang->def('_TASKS'));
