...
class FieldList
{
    ...
    /**
     * ABR: Restituisce gli id campi a partire da nomi campo tradotti
     */
    public function getFieldIdsFromTranslations($translations)
    {
		$res = array();
		
        $query = "SELECT id_common" .
            " FROM " . $this->getFieldTable().
            " WHERE translation IN ('" .implode("','", $translations). "')";
		...
		{
			$res[ $row['id_common'] ] = $row['id_common'];
		}
