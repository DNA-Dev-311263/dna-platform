<div class="pui-page ar-page">
    ...
    <div class="dash-canvas">
        <div class="dash-board ar-filters-row" style="grid-template-columns: 1fr;">
            <div class="dash-col">
                <div class="dash-col__title"><span class="dot dot--users"></span> <?php echo Lang::t('_FILTERS', 'statistic'); ?></div>
        ...
        <div class="dash-board dash-board--2col ar-split" id="ar_split" style="display:none;">
            <form id="ar_export_form" method="get" action="ajax.adm_server.php" class="dash-col">
                <div class="dash-col__title"><span class="dot dot--companies"></span> <?php echo Lang::t('_ENROL_COUNT', 'standard'); ?></div>
            ...
            <div class="dash-col ar-preview" id="ar_preview">
                <div class="dash-col__title"><span class="dot dot--courses"></span> <?php echo Lang::t('_PREVIEW', 'standard'); ?></div>
