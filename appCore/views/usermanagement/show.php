...
$dyn_labels = [];
    ...
    $icon_su  = '<i class="fa fa-user-secret" title="Accedi come" style="font-size:15px;color:#d97706;"></i>';
    ...
    $arr_fields = ['id', 'userid', 'firstname', 'lastname', 'profile', 'unassoc', 'valid', 'mod', 'del', 'su'];
    for ($i = 0; $i < $num_var_fields; ++$i) {
