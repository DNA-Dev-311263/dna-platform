...
class Lms_TabWidget extends Widget
{
    ...
    public $show = 'elearning,classroom,catalog,assessment,coursepath,games,communication,videoconference,courseassn,kb'; 		//ABR
    ...
    {
        $class = '';
        if ($tab_name == $this->active) {
            $class .= 'active';
        }
        if ($other_classes != false) {
            $class .= ' ' . $other_classes;
        }
